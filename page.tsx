          ...
          <div className="tablewrap">
            {visibles.length === 0 ? (
              ...
              <table>
                ...
                <tbody>
                  {visibles.map((r) => (
                    <tr key={r.ref} className={r.statut === "besoin" ? "" : "couvert"}>
                      <td>{r.ref}</td>
                      <td>{r.libelle}</td>
